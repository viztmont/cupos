<?php 
    session_start();
	class Jcasesores extends Controllers{
		...
		public function Jcasesores(){
			$data['page_tag'] = "Manejo Camiones Jiboa";
			$data['page_name'] = "Manejo Cupos Camiones Planta Jiboa";
			$data['page_title'] = "Manejo Cupos Camiones Planta Jiboa";
			$data['page_functions_js'] = "functions_jcasesores.js";
			$this->views->getView($this,"jcasesores",$data);		
		}
