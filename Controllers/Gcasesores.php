<?php 
    session_start();
	class Gcasesores extends Controllers{
		...
		public function Gcasesores(){
			$data['page_tag'] = "Manejo Camiones Guazapa";
			$data['page_name'] = "Manejo Cupos Camiones Planta Guazapa";
			$data['page_title'] = "Manejo Cupos Camiones Planta Guazapa";
			$data['page_functions_js'] = "functions_gcasesores.js";
			$this->views->getView($this,"gcasesores",$data);		
		}
