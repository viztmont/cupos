<?php 
	class AcuposrgModel extends Mysql{
		...
		public function updateAcuporg(int $idcupo, string $hora_asignada, string $cliente, string $metodo_carga, string $cotizacion , string $ruta, string $estado, int $tendidos_tarimas, int $capacidad_tarimas, int $cantidad_tarimas, string $observacion_asignacion){
		...
		public function selectAcuporg(int $idcupo){
			$this->intCupo_id = $idcupo;
