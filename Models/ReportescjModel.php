<?php
	class ReportescjModel extends Mysql{
		...
		public function selectReportescj() {
			$sql = "SELECT * FROM cupos_camiones WHERE tipo_transporte=4";
		...
		public function select_finalizado(string $fechaInicio, string $fechaFinal){
			$this->strFechaInicio = $fechaInicio;
			$this->strFechaFinal = $fechaFinal;
			$sql = "SELECT COUNT(*) as total FROM cupos_camiones WHERE tipo_transporte=4 AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}' AND estado='Finalizado'";
			$request = $this->select($sql);
			$total = $request['total']; 
			return $total;
		}
		public function cuposT(string $fechaInicio, string $fechaFinal){
			$this->strFechaInicio = $fechaInicio;
			$this->strFechaFinal = $fechaFinal;
			$sql = "SELECT COUNT(*) as totalT FROM cupos_camiones WHERE tipo_transporte=4 AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}'";
			$request = $this->select($sql);
		...
		public function pagaCargaF(string $fechaInicio, string $fechaFinal){
			$this->strFechaInicio = $fechaInicio;
			$this->strFechaFinal = $fechaFinal;
			$sql = "SELECT COUNT(*) as totalPCF FROM cupos_camiones WHERE tipo_transporte=4 AND tipo_logistica='Domicilio' AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}' AND estado='Finalizado'";
			$request = $this->select($sql);
		...
		public function NopagaCargaF(string $fechaInicio, string $fechaFinal){
			$this->strFechaInicio = $fechaInicio;
			$this->strFechaFinal = $fechaFinal;
			$sql = "SELECT COUNT(*) as totalNPCF FROM cupos_camiones WHERE tipo_transporte=4 AND tipo_logistica='Transporte propio' AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}' AND estado='Finalizado'";
			$request = $this->select($sql);
		...
		public function pagaCarga(string $fechaInicio, string $fechaFinal){
			$this->strFechaInicio = $fechaInicio;
			$this->strFechaFinal = $fechaFinal;
			$sql = "SELECT COUNT(*) as totalPC FROM cupos_camiones WHERE tipo_transporte=4 AND tipo_logistica='Domicilio' AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}'";
			$request = $this->select($sql);
		...
		public function NopagaCarga(string $fechaInicio, string $fechaFinal){
			$this->strFechaInicio = $fechaInicio;
			$this->strFechaFinal = $fechaFinal;
			$sql = "SELECT COUNT(*) as totalNPC FROM cupos_camiones WHERE tipo_transporte=4 AND tipo_logistica='Transporte propio' AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}'";
			$request = $this->select($sql);
		...
		public function promedioPagaCarga(string $fechaInicio, string $fechaFinal){
			...
			FROM cupos_camiones WHERE tipo_transporte=4 AND tipo_logistica='Domicilio'  AND estado='Finalizado' AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}'";
			$request = $this->select($sql);
		...
		public function promedioNoPagaCarga(string $fechaInicio, string $fechaFinal){
			...
			FROM cupos_camiones WHERE tipo_transporte=4 AND tipo_logistica='Transporte propio'  AND estado='Finalizado' AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}'";
			$request = $this->select($sql);
		...
		public function promedioNoPagaCargaS(string $fechaInicio, string $fechaFinal){
			...
			FROM cupos_camiones WHERE tipo_transporte=4 AND tipo_logistica='Trasnporte propio'  AND estado='Finalizado' AND fecha>='{$this->strFechaInicio}' AND fecha<='{$this->strFechaFinal}'";
			$request = $this->select($sql);
