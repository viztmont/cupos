<?php 
	class AcuposcjModel extends Mysql{
		...
		/* - MANEJO DE DATOS - */
		public function updateAcupocj(int $id_cupo, string $estado, string $nombre_cliente, string $tipo_logistica, 
		...
		/* -TRAER LOS DATOS DEL CUPO- */
		public function selectAcupocj(int $idcupo){
