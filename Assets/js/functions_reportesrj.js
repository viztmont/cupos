...
document.addEventListener('DOMContentLoaded', function(){
    tableReportesRJ = $('#tableReportesRJ').dataTable( {
        "aProcessing":true,
        "aServerSide":true,
        "language": {
        ...
        "ajax":{
            "url": " "+base_url+"/Reportesrj/getReportesrj",
            "dataSrc":""
        },
        "columns":[
            {"data":"id_cupo"},
...
function fntViewReportesrj(idcupo){
...
function consultaRJR() {
    let from_date = $('#txt001RJR').val();
    let to_date = $('#txt002RJR').val();
    tableReportesRJ = $('#tableReportesRJ').dataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
        ...
        "ajax": {
            "url": " " + base_url + "/Reportesrj/consultaRJ/",
            method: "POST",
...
function reporte001RJ() {
    let from_date = $('#txt001RJR').val();
    let to_date = $('#txt002RJR').val();
    
    document.querySelector("#plantat").innerHTML = "Reporte rastras planta Jiboa";
    document.querySelector("#planta").innerHTML = "Planta Jiboa";
    ...
    let ff = "f="+to_date;    
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Reportesrj/FinalizadoRJ/'+fi;
