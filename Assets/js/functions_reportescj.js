...
document.addEventListener('DOMContentLoaded', function(){
    ...
    tableReportesCJ = $('#tableReportesCJ').dataTable( {
        "aProcessing":true,
        "aServerSide":true,
        "language": {
        ...
        "ajax":{
            "url": " "+base_url+"/Reportescj/getReportescj",
            "dataSrc":""
        },
        "columns":[
            {"data":"id_cupo"},
...
function fntViewReportescj(idcupo){
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status){
                ...
                if (objData.data.tipo_logistica == 'Transporte propio') {
                    ...
                    document.querySelector("#celRFleteCTP").innerHTML = objData.data.flete;
                    document.querySelector("#celRQuintalesCTP").innerHTML = objData.data.quintales;
...
function consultaCJR() {
    let from_date = $('#txt001CJR').val();
    let to_date = $('#txt002CJR').val();
    tableReportesCJ = $('#tableReportesCJ').dataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
        ...
        "ajax": {
            "url": " " + base_url + "/Reportescj/consultaCJ/",
            method: "POST",
...
function reporte001CJ() {
    let from_date = $('#txt001CJR').val();
    let to_date = $('#txt002CJR').val();
    
    document.querySelector("#plantatc").innerHTML = "Reporte camiones planta Jiboa";
    document.querySelector("#plantac").innerHTML = "Planta Jiboa";
    document.querySelector("#transportec").innerHTML = "Transporte de Jiboa";
    ...
    let ff = "f="+to_date;    
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Reportescj/FinalizadoCJ/'+fi;
