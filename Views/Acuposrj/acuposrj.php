<?php 
    headerAdmin($data);
    getModal('modalAcuposrg',$data);
    require_once ('Controllers/Acuposrj.php');
    $ins_acb= new Acuposrj();
    $Year = strftime("%Y");
    $Semana = date("W");
    $Dia = date("N");
    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered" id="tableAcuposrj">
              <thead>
                <tr>
                ...
                <?php
                    ...
                    for ($i=0; $i<$cupos; $i++){
                      ...
                      if($_SESSION['permisosMod']['w'] && $user==''.$name || $user=='Root Root'){
                        $btnEdit = '<button class="btn btn-primaryV btn-sm" onClick="fntEditAcuposrj('.$id.')" title="Editar datos"><i class="fas fa-edit"></i></button>';
                      }else{
                        $btnEdit = '<button class="btn btn-primaryV  btn-sm" title="Acceso denegado" disbled><i class="fas fa-edit"></i></button>';
                      }
                      if($_SESSION['permisosMod']['r'] && $user==''.$name || $user=='Root Root'){
                        $btnView = '<button class="btn btn-viewAC btn-sm" onClick="fntViewAcuposrj('.$id.')" title="Ver datos"><i class="fas fa-eye"></i></button>';
                      }else{
