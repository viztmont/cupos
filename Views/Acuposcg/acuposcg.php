<?php 
    ...
    require_once ('Controllers/Acuposcg.php');
    $ins_acb= new Acuposcg();
    $Year = strftime("%Y");
    $Semana = date("W");
    $Dia = date("N");
    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered" id="tableAcuposcg">
              <thead>
                <tr>
                  ...
                  <?php
                    ...
                    for ($i=0; $i<$cupos; $i++){
                      ...
                      if($_SESSION['permisosMod']['w'] && $user==''.$name || $user=='Root Root'){
                        $btnEdit = '<button class="btn btn-primaryV btn-sm" onClick="fntEditAcuposcg('.$id.')" title="Editar datos"><i class="fas fa-edit"></i></button>';
                      }else{
                      ...
                      if($_SESSION['permisosMod']['r'] && $user==''.$name || $user=='Root Root'){
                        $btnView = '<button class="btn btn-viewAC btn-sm" onClick="fntViewAcuposcg('.$id.')" title="Ver datos"><i class="fas fa-eye"></i></button>';
                      }else{
