<?php 
    ...
    require_once ('Controllers/Acuposrg.php');
    $ins_acb= new Acuposrg();
    $Year = strftime("%Y");
    $Semana = date("W");
    $Dia = date("N");
    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered" id="tableAcuposrg">
              <thead>
                <tr>
                  ...
                  <?php
                    ...
                    for ($i=0; $i<$cupos; $i++){
                      ...
                      if($_SESSION['permisosMod']['w'] && $user==''.$name || $user=='Root Root'){
                        $btnEdit = '<button class="btn btn-primaryV btn-sm" onClick="fntEditAcuposrg('.$id.')" title="Editar datos"><i class="fas fa-edit"></i></button>';
                      }else{
                      ...
                      if($_SESSION['permisosMod']['r'] && $user==''.$name || $user=='Root Root'){
                        $btnView = '<button class="btn btn-viewAC btn-sm" onClick="fntViewAcuposrg('.$id.')" title="Ver datos"><i class="fas fa-eye"></i></button>';
                      }else{
              ...
              <tr class="g-asignar-cupos-tr">
                ...
                <!-- MIERCOLES BLOQUE 4 *3:00:PM-6:00:PM* -->
                <td class="g-asignar-cupos-td">
                  <?php
