<?php 
    ...
    require_once ('Controllers/Gcasesores.php');
    $ins_acb= new Gcasesores();
    $Year = strftime("%Y");
    $Semana = date("W");
    $Dia = date("N");
      ...
      <div class="tile">
        <div class="tile-body">
          <div class="table-responsive">
            <table class="table table-hover table-bordered" id="tableGcasesores">
                <thead>
                  <tr>
                    ...
                    <?php
                      ...
                      for ($i=0; $i<$cupos; $i++) {
                        ...
                        if($_SESSION['permisosMod']['w']){
                          $btnAsesor = '<button class="btn btn-primary  btn-sm" onClick="fntEditGcasesores('.$id.')" title="Editar asesor"><i class="fas fa-pencil-alt"></i></button>';
                        }else{
                          $btnAsesor = '<button class="btn btn-primary  btn-sm" title="Acceso denegado" disabled><i class="fas fa-pencil-alt"></i></button>';
                        }
                        if($_SESSION['permisosMod']['d']){
                          $btnEliminarCupos = '<button class="btn btn-danger btn-sm" onClick="fntDelGcasesores('.$id.')" title="Eliminar cupo"><i class="far fa-trash-alt"></i></button>';
                          $btnEliminrAsesor = '<button class="btn btn-info btn-sm" onClick="fntCleanGcasesores('.$id.')" title="Limpiar"><i class="fa fa-eraser"></i></button>';
                        }else{
