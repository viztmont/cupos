<?php 
    ...
    require_once ('Controllers/Jrasesores.php');
    $ins_acb= new Jrasesores();
    $Year = strftime("%Y");
    $Semana = date("W");
    $Dia = date("N");
      ...
      <div class="tile">
        <div class="tile-body">
          <div class="table-responsive">
            <table class="table table-hover table-bordered" id="tableJrasesores">
               <thead>
                  <tr>
                    ...
                    <?php
                      ...
                      for ($i=0; $i<$cupos; $i++) {
                        ...
                        if($_SESSION['permisosMod']['w']){
                          $btnAsesor = '<button class="btn btn-primary  btn-sm" onClick="fntEditJrasesores('.$id.')" title="Editar asesor"><i class="fas fa-pencil-alt"></i></button>';
                          $btnTipoCarga = '<button class="btn btn-warning btn-sm" onClick="fntCargaJrasesores('.$id.')" title="Tipo carga"><i class="fa fa-truck"></i></button>';
                        }else{
                        ...
                        if($_SESSION['permisosMod']['d']){
                          $btnEliminarCupos = '<button class="btn btn-danger btn-sm" onClick="fntDelJrasesores('.$id.')" title="Eliminar cupo"><i class="far fa-trash-alt"></i></button>';
                          $btnEliminrAsesor = '<button class="btn btn-info btn-sm" onClick="fntCleanJrasesores('.$id.')" title="Limpiar"><i class="fa fa-eraser"></i></button>';
                        }else{
