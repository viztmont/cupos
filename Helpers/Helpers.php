<?php    
    ...
    function deleteFile(string $name){
     ...
     /* guardar cotizaciones de las crastras */
     function uploadFileR(array $data, string $name){
        $url_temp = $data['tmp_name'];
        $destino    = 'Assets/cotizacion/rastras/'.$name;        
        $move = move_uploaded_file($url_temp, $destino);
        return $move;
    }

    function deleteFileR(string $name){
        unlink('Assets/cotizacion/rastras/'.$name);
    }


    /* guardar cotizaciones de los camiones */
    function uploadFileC(array $data, string $name){
        $url_temp = $data['tmp_name'];
        $destino    = 'Assets/cotizacion/camiones/'.$name;        
        $move = move_uploaded_file($url_temp, $destino);
        return $move;
    }

    function deleteFileC(string $name){
        unlink('Assets/cotizacion/camiones/'.$name);
    }
